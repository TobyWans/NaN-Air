...
class DLAPI:
    ...
    def get_all_reports(self, wr_id):
        return self.ReqDL.get_all_reports(wr_id)
    ...
    def change_req(self,change_req, req_id):
        return self.ReqDL.change_request_prep(change_req, req_id)
    ...
    def get_rental_status_by_location(self, user_location):
        return self.housDL.get_rental_status_by_location(user_location)
